#[doc = "Reader of register CANIDMR5"]
pub type R = crate::R<u8, super::CANIDMR5>;
#[doc = "Writer for register CANIDMR5"]
pub type W = crate::W<u8, super::CANIDMR5>;
#[doc = "Register CANIDMR5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CANIDMR5 {
    type Type = u8;
    #[inline(always)]
