#[doc = "Reader of register CANIDMR0"]
pub type R = crate::R<u8, super::CANIDMR0>;
#[doc = "Writer for register CANIDMR0"]
pub type W = crate::W<u8, super::CANIDMR0>;
#[doc = "Register CANIDMR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CANIDMR0 {
    type Type = u8;
    #[inline(always)]
