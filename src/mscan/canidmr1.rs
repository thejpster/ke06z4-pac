#[doc = "Reader of register CANIDMR1"]
pub type R = crate::R<u8, super::CANIDMR1>;
#[doc = "Writer for register CANIDMR1"]
pub type W = crate::W<u8, super::CANIDMR1>;
#[doc = "Register CANIDMR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CANIDMR1 {
    type Type = u8;
    #[inline(always)]
