#[doc = "Reader of register CANIDMR4"]
pub type R = crate::R<u8, super::CANIDMR4>;
#[doc = "Writer for register CANIDMR4"]
pub type W = crate::W<u8, super::CANIDMR4>;
#[doc = "Register CANIDMR4 `reset()`'s with value 0"]
impl crate::ResetValue for super::CANIDMR4 {
    type Type = u8;
    #[inline(always)]
