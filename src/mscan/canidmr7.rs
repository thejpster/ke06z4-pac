#[doc = "Reader of register CANIDMR7"]
pub type R = crate::R<u8, super::CANIDMR7>;
#[doc = "Writer for register CANIDMR7"]
pub type W = crate::W<u8, super::CANIDMR7>;
#[doc = "Register CANIDMR7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CANIDMR7 {
    type Type = u8;
    #[inline(always)]
