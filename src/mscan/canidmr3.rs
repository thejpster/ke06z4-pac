#[doc = "Reader of register CANIDMR3"]
pub type R = crate::R<u8, super::CANIDMR3>;
#[doc = "Writer for register CANIDMR3"]
pub type W = crate::W<u8, super::CANIDMR3>;
#[doc = "Register CANIDMR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::CANIDMR3 {
    type Type = u8;
    #[inline(always)]
